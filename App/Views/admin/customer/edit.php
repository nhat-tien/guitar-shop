...
<body>
                ...
                <div class="col-2 gap-1 mt-1">
                    <div class="flex flex-col gap-1">
                        <div class="text-field">
                            ...
                            <input name="customer_name" type="text" class="text-field__input" value="<?= $customer->customer_name ?>" />
                        </div>
                        <div class="text-field">
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="text-field">
                            ...
                            <input name="email" type="email" class="text-field__input" value="<?= $customer->customer_email ?>" />
                        </div>
                        <div class="text-field">
                            <label class="text-field__label">Địa chỉ</label>
                            <input name="address" type="text" class="text-field__input" value="<?= $customer->address ?>" />
                        </div>
                    </div>
                </div>
    ...
    <script>
        function handleSubmit() {
            ...
            fetch("/admin/customers/" + <?= $customer->customer_id ?>, {
                method: "POST",
                body: formData
            }).then(e => e.json())
            .then(e => {
