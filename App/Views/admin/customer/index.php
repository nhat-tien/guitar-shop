                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="menu-list-container">
                                        <button id="ctn-<?= $customer->customer_id ?>" class="action-icon" onclick="openMenu('ctn-<?= $customer->customer_id ?>', 'pd-<?= $customer->customer_id ?>')">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 12.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 18.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" />
                                            </svg>
                                        </button>
                                        <ul id="pd-<?= $customer->customer_id ?>" class="menu-list">
                                            <li>
                                                <a class="menu-list__item btn-update" href="/admin/customers/<?= $customer->customer_id ?>/edit">
                                            ...
                                            <li>
                                                <button class="menu-list__item" onclick="handleDelete('<?= $customer->customer_id ?>')">
                                                    <div class="menu-list__icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
