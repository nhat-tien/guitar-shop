...
<body>
                ...
                <div class="col-2 gap-1 mt-1">
                    <div class="flex flex-col gap-1">
                        <div class="text-field">
                            ...
                            <input name="user_name" type="text" class="text-field__input" value="<?= $user->user_name ?>" />
                        </div>
                        <div class="text-field">
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="text-field">
                            ...
                            <input name="email" type="email" class="text-field__input" value="<?= $user->user_email ?>" />
                        </div>
                        <div class="text-field">
                            <label class="text-field__label">Địa chỉ</label>
                            <input name="address" type="text" class="text-field__input" value="<?= $user->address ?>" />
                        </div>
                    </div>
                </div>
    ...
    <script>
        function handleSubmit() {
            ...
            fetch("/admin/users/" + <?= $user->user_id ?>, {
                method: "POST",
                body: formData
            }).then(e => e.json())
            .then(e => {
